...
import kotlinx.android.synthetic.main.controller_resto.*
import kotlinx.android.synthetic.main.controller_resto.view.*
import kotlinx.android.synthetic.main.item_date.*
import java.util.*


class RestoActivity() : BaseMvpActivity<RestoActivityContract.View, RestoActivityContract.Presenter>(), RestoActivityContract.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        setContentView(R.layout.controller_resto)
        Log.i("code", "resto")
    ...
    override fun createPresenter(): RestoActivityContract.Presenter {
        return RestoActivityPresenter()
    }
